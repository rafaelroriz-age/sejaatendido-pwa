    ...
    <div style={s.page}>
      ...
      <section id="funcionalidades" style={s.section}>
        <div style={s.container}>
          ...
          <div style={s.featGrid}>
            {[
              { icon: <IconCalendar />, title: 'Agendamento inteligente', desc: 'Escolha o médico, selecione data e horário na janela de atendimento (06h a 00h) e confirme em poucos toques.' },
      ...
      <section style={s.cta}>
        <div style={{ maxWidth: 620, margin: '0 auto', padding: '0 20px' }}>
          ...
          <p style={s.ctaDesc}>Crie sua conta gratuitamente e comece a agendar consultas agora mesmo.</p>
